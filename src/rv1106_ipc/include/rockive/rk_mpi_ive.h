 ...
 * Description  :
 * @param pHandle: Returned handle ID of a task
 * @param pstBgDiffFg: Background subtraction foreground image
 * @param pstCurGrad: Current gradient image, both horizontally and vertically
*                     graded in accordance with [xyxyxy ...] format
 * @param pstBgGrad: Background gradient image
 * @param pstGradFg: Gradient foreground image
 * @param pstGradFgCtrl: Control parameters.
 * @param bInstant: set bInstant to TRUE blocks the next operation.
 * @return RK_S32: RVE_OK: Success.
 *                 Error codes: Failure.
 */
